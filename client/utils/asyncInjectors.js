 ...
 */
export const injectAsyncReducer = (store, isValid) => function injectReducer(name, asyncReducer) {
 ...
 */
export const injectAsyncSagas = (store, isValid) => function injectSagas(sagas) {
  if (!isValid) checkStore(store);
